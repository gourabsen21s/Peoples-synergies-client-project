...
const topItems = [
  {
    ...
    description:
      "We collaborate with your team to define role requirements and cultural fit.",
    images: [
      {
  ...
  },
  {
    ...
    description: "We test candidates across modern tech stacks and operations.",
    images: [
...
const bottomItems = [
  {
    title: "Shortlisting.",
    description:
      "Presenting a curated list of professionals ready to make an impact.",
    images: [
      {
  ...
  },
  {
    title: "Interviews.",
    description:
      "Rigorous technical and behavioral assessments.",
    images: [
      {
  ...
  },
  {
    title: "Onboarding.",
    description:
      "Facilitating final offers and ensuring smooth transitions.",
    images: [
      {
    ...
    >
      <div className="">
        <h2 className="container text-center text-3xl tracking-tight text-balance sm:text-4xl md:text-5xl lg:text-6xl">
          The recruitment process, streamlined.
        </h2>
