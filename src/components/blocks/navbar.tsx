    ...
    dropdownItems: [
      {
        ...
        href: "/employers",
        description:
          "Customized recruitment workflows tailored to your specific organizational needs",
      },
      {
        title: "For Job Seekers",
        href: "/job-seekers",
        description: "Submit your resume or join our talent pool to find your next career move",
      },
    ],
  },
    ...
    >
      <div className="flex items-center justify-between px-6 py-3">
        <Link href="/" className="flex shrink-0 items-center gap-2">
          <span className="font-bold text-xl tracking-tighter">Peoples Synergies</span>
        </Link>
